...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BmobObject *itObj = [unread objectForKey:@"itObj"];
    
    cell.textLabel.text = [itObj objectForKey:@"title"];
    cell.detailTextLabel.text = [[[unread objectForKey:@"unreadCount"] stringValue]stringByAppendingString:@"条未读消息"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //把bmob对象转成itObj对象
    vc.itObj = [[TRITObject alloc]initWithBmobObj:itObj];
